...
class CdrFactory
{
    ...
    public static function createDetailsFromArray(array $data, ?TariffCollection $tariffCollection = null): CdrDetails
    {
        return new CdrDetails(
            ...
            SignedDataFactory::fromArray($data['signed_data'] ?? null),
            PriceFactory::fromArray($data['total_cost']),
            PriceFactory::fromArray($data['total_fixed_cost'] ?? null),
            $data['total_energy'],
            PriceFactory::fromArray($data['total_energy_cost'] ?? null),
            $data['total_time'],
            PriceFactory::fromArray($data['total_time_cost'] ?? null),
            $data['total_parking_time'] ?? 0,
            PriceFactory::fromArray($data['total_parking_cost'] ?? null),
            PriceFactory::fromArray($data['total_reservation_cost'] ?? null),
            $data['remark'] ?? null,
