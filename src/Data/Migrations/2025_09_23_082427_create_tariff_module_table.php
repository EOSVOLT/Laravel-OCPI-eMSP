...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create(config('ocpi.database.table.prefix') . 'tariff_parties', function (Blueprint $table) {
            $table->foreignId('tariff_id')->constrained(config('ocpi.database.table.prefix') . 'tariffs', 'id')->onDelete('cascade');
            $table->foreignId('party_id')->constrained(config('ocpi.database.table.prefix') . 'parties', 'id')->onDelete('cascade');
