...
return new class extends Migration {
    ...
    {
        Schema::create(config('ocpi.database.table.prefix') . 'command_token', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists(config('ocpi.database.table.prefix') . 'command_token');
    }
};
